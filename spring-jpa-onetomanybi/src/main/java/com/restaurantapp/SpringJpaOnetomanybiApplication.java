...
public class SpringJpaOnetomanybiApplication implements CommandLineRunner {

	public static void main(String[] args) {
		SpringApplication.run(SpringJpaOnetomanybiApplication.class, args);
	}
...
//		System.out.println();
		...
		itemService.getByCategory(Category.BREAKFAST).forEach(System.out::println);
		System.out.println();
		
		itemService.getByRestaurant("Anand").forEach(System.out::println);
		System.out.println();
		
		itemService.getByRestaurantCategory("Baba", Category.MAINCOURSE).forEach(System.out::println);
		System.out.println();
		
		itemService.getByCuisineAndCity("NORTHINDIAN", "Hyderabad").forEach(System.out::println);
		System.out.println();
		
		itemService.getByItemNameRating("Biryani", 4).forEach(System.out::println);
		System.out.println();
		
		itemService.getByRestaurantItemType("Baba", Type.NONVEG).forEach(System.out::println);
		
		
		Item item=new Item("Laddu",Cusine.SOUTHINDIAN.toString(),Category.DESSERTS,Type.VEG,50);
		//Restaurant restaurant=restaurantSEr
